...
"defino la tecla leader space
let mapleader = " "

"config theme
set background=dark
let ayucolor="dark"
let g:grovbox_contrast_dark="hard"
colorscheme gruvbox
...
"se guarda con leader + w
nnoremap <leader>w :w<CR>

"se cierra con leader + q
...
"config coc
autocmd FileType pytho let b:coc_suggest_disable= 1
...
"autocompletado entre kite y coc(config)
"using <c-space> to trigger completion.

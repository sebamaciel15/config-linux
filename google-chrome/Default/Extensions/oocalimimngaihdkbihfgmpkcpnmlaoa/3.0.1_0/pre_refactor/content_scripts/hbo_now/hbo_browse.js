var injectBrowseScript = function() {
    ...
    }, triggerCometRequest = function() {
        return new Promise((async (resolve, reject) => {
            try {
                await new Promise((async (resolve, reject) => {
                    if (console.log("Attempting to toggle"), console.log(jQuery("video")), console.log(jQuery("video").is(":visible")), 
                    console.log(jQuery("[style*='_add']").is(":visible")), console.log(jQuery("[style*='_remove']").is(":visible")), 
                    jQuery("[style*='_add']").length && jQuery("[style*='_add']").is(":visible")) console.log("toggling add "), 
                    jQuery("[style*='_add']").addClass("listToggle"); else {
                        if (!jQuery("[style*='_remove']").length || !jQuery("[style*='_remove']").is(":visible")) return console.log("No toggle"), 
                        void reject();
                        console.log("toggling remove"), jQuery("[style*='_remove']").addClass("listToggle");
                    }
                ...
                console.log("Toggle failed, waiting then try again"), await delay(200)(), await triggerCometRequest(), 
                resolve();
            }
        }));
    };
    ...
    var browseInteraction = function(event) {
        ...
        pushTask(triggerCometRequest), pushTask(triggerCometRequest));
    };

/*! For license information please see hulu_content_script_netflix.js.LICENSE.txt */
!function() {
    if (!window.netflixPartyLoaded) {
        window.netflixPartyLoaded = !0, a = "undefined" != typeof window ? window : this, 
        b = function(a, b) {
            ...
            n.acceptData = function(a) {
                ...
                remove: function(a, b) {
                    ...
                    if (void 0 === b) this.cache[f] = {}; else {
                        n.isArray(b) ? d = b.concat(b.map(n.camelCase)) : (e = n.camelCase(b), d = b in g ? [ b, e ] : (d = e) in g ? [ d ] : d.match(E) || []), 
                        c = d.length;
                        for (;c--; ) delete g[d[c]];
                    }
                },
            ...
            var La, Ma, Na = /^(?:toggle|show|hide)$/, Oa = new RegExp("^(?:([+-])=|)(" + Q + ")([a-z%]*)$", "i"), Pa = /queueHooks$/, Qa = [ function(a, b, c) {
                ...
                "inline" === ("none" === (j = n.css(a, "display")) ? L.get(a, "olddisplay") || ta(a.nodeName) : j) && "none" === n.css(a, "float") && (o.display = "inline-block")), 
            ...
            n.fn.extend({
                ...
                attr: function(a, b, c) {
                    ...
                    d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? Za : void 0)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : null == (e = n.find.attr(a, b)) ? void 0 : e : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), 
            ...
            return b(a);
        } : b(a), jQuery.noConflict(), function(f) {
        ...
        var escapeStr = function(str) {
            ...
            return function(result) {
                var startTime = (new Date).getTime(), checkForCondition = function() {
                    return condition() ? Promise.resolve(result) : null !== maxDelay && (new Date).getTime() - startTime > maxDelay ? Promise.reject(Error("delayUntil timed out")) : (console.log("delay"), 
                    delay(250)().then(checkForCondition));
                };
        ...
        var injectScript = function(script) {
            ...
            s.textContent = script, (document.head || document.documentElement).appendChild(s), 
            s.remove();
        };
        !function(a, b) {
            "object" == typeof module && "object" == typeof module.exports ? module.exports = a.document ? b(a, !0) : function(a) {
        ...
        var uiEventsHappening = 0, lastDuration = 6e4, getDuration = function() {
            var video = jQuery("video");
            return video.length > 0 && (lastDuration = Math.floor(1e3 * video[0].duration)), 
            lastDuration;
        }, getState = function() {
            return 0 == jQuery("video").length || "" === jQuery("video")[0].src ? "notready" : jQuery(".loading-screen-container").length > 0 && "flex" === jQuery(".loading-screen-container")[0].style.display ? "loading" : "" !== jQuery("video")[1].src || jQuery(".AdUnitView__adBar__timer").length > 0 || !0 === currWatchingAds ? "ad-playing" : jQuery(".PauseButton").length > 0 ? "playing" : jQuery(".PlayButton").length > 0 ? "paused" : void 0;
        };
        var waitVideoReady = function() {
            ...
            return function() {
                return new Promise((function(resolve, reject) {
                    return delay(250)().then(delayUntil((function() {
                        return console.log("check video is called"), document.getElementsByTagName("video").length > 0;
                    }), 1 / 0)).then(delayUntil((function() {
                        return console.log("check load is called"), 4 === document.getElementsByTagName("video")[0].readyState;
                    }), 1 / 0)).then(delayUntil((function() {
                        return console.log("userId wait video ready: " + userId), null != userId;
                    }), 1 / 0)).then(delayUntil((function() {
                        return !function(obj) {
                        ...
                        console.log("userId and userSettings are ready!"), resolve();
                    }));
                }));
            };
        }, getPlaybackPosition = function() {
            return jQuery("video")[0] ? Math.floor(1e3 * jQuery("video")[0].currentTime) : null;
        }, wakeUp = function() {
            ...
            return uiEventsHappening += 1, jQuery("video")[0].paused || jQuery(".PauseButton").length > 0 && jQuery(".PauseButton")[0].click(), 
            delayUntil((function() {
                return "paused" === getState();
            }), 1e3)().then(hideControls).ensure((function() {
                uiEventsHappening -= 1;
            }));
        }, play = function() {
            return uiEventsHappening += 1, jQuery("video")[0].paused && jQuery(".PlayButton").length > 0 && jQuery(".PlayButton")[0].click(), 
            delayUntil((function() {
                return "playing" === getState();
            }), 2500)().then(hideControls).ensure((function() {
                uiEventsHappening -= 1;
            }));
        }, seekErrorRecent = [];
        injectScript('window.seekScriptLoaded=!0;var seekInteraction=function(e){if(e.source==window){if(e.data.type&&"SEEK"==e.data.type)document.querySelector(\'video\').__HuluDashPlayer__.currentTime=e.data.time/1000;e.data.type&&"teardown"==e.data.type&&(window.removeEventListener("message",seekInteraction,!1),window.seekScriptLoaded=!1)}};window.addEventListener("message",seekInteraction,!1);');
        var seek = function(milliseconds) {
            return function() {
                var newPlaybackPosition;
                uiEventsHappening += 1;
                var alreadyUpdated = !1;
                return console.log("seek called at " + function(d) {
                    d = Number(d);
                    var h = Math.floor(d / 3600), m = Math.floor(d % 3600 / 60), s = Math.floor(d % 3600 % 60);
                    return (h > 0 ? h + (1 == h ? " hour, " : " hours, ") : "") + (m > 0 ? m + (1 == m ? " minute, " : " minutes, ") : "") + (s > 0 ? s + (1 == s ? " second" : " seconds") : "");
                }(milliseconds / 1e3)), window.postMessage({
                    type: "SEEK",
                    time: milliseconds
                }, "*"), delay(250)().then(delayUntil((function() {
                    if (!alreadyUpdated) {
                        alreadyUpdated = !0, socket.emit("buffering", {
                            buffering: !0
                        }, (function() {}));
                        var time = new Date, timeStatus = " at" + time.getHours() + ":" + time.getMinutes() + ":" + time.getMilliseconds() + "AM";
                        console.log("simulated seek: buffering start -> server" + timeStatus);
                    }
                    return newPlaybackPosition = getPlaybackPosition(), "loading" !== getState();
                }), 1e4)).catch((function(e) {
                    ...
                    var array, time = new Date, timeStatus = " at" + time.getHours() + ":" + time.getMinutes() + ":" + time.getMilliseconds() + "AM";
                    if (console.log("simulated seek finished: buffering end -> server" + timeStatus), 
                    newPlaybackPosition) {
                        var newSeekError = Math.min(Math.max(newPlaybackPosition - milliseconds, -1e4), 1e4);
                        shove(seekErrorRecent, newSeekError, 5), (array = seekErrorRecent).reduce((function(a, b) {
                            return a + b;
                        })) / array.length;
                    }
        ...
        var socket, url = window.location.href, herokuSocket = !1;
        console.log("content script url: " + url);
        var sessionIdFromUrl = getURLParameter(url, "npSessionId", 1), npServerIdFromUrl = getURLParameter(url, "npServerId", 1), sessionIdFromReferrer = function(url) {
            ...
            var id;
            return null;
        }(window.document.referrer), npServerIdFromReferrer = getURLParameter(window.document.referrer, "s", 1);
        sessionIdFromReferrer && (console.log("sessionIdFromReferrer: " + sessionIdFromReferrer), 
        sessionIdFromUrl = sessionIdFromReferrer), npServerIdFromReferrer && (console.log("npServerIdFromReferrer: " + npServerIdFromReferrer), 
        ...
        console.log(npServerIdFromUrl), console.log(sessionIdFromUrl);
        var defaultServer = defaultServerOptions[Math.floor(Math.random() * defaultServerOptions.length)], serverId = npServerIdFromUrl || defaultServer, corsOptions = {
            transports: [ "websocket" ]
        };
        npServerIdFromUrl ? servers[npServerIdFromUrl] ? (socket = io("https://" + npServerIdFromUrl + ".netflixparty.com/", corsOptions), 
        console.log("socket: https://" + npServerIdFromUrl + ".netflixparty.com/")) : (socket = io("https://netflixparty-server.herokuapp.com", corsOptions), 
        console.log("socket: https://netflixparty-server.herokuapp.com"), herokuSocket = !0) : (socket = io("https://" + defaultServer + ".netflixparty.com/", corsOptions), 
        console.log("socket: https://" + defaultServer + ".netflixparty.com/"));
        var userId = null;
        socket.on("userId", (function(data) {
            console.log("userId: " + JSON.stringify(data)), null === userId && (userId = data);
        }));
        var currWatchingAds = !1, currAd = {};
        var broadcastCurrAd = function(currAd) {
            socket.emit("broadcastActiveAd", {
                userAd: currAd
            }, (function() {}));
        };
        socket.on("updateActiveAd", (function(data) {}));
        currWatchingAds = !1;
        var everyoneWatchingAds = !1;
        var myObserver2 = new (window.MutationObserver || window.WebKitMutationObserver)((function(mutationRecords) {
            document.querySelector(".AdUnitView__adBar__timer") && !document.querySelector(".AdUnitView__adBar__timer").className.includes("fix-ad-width") && (document.querySelector(".AdUnitView__adBar__timer").style = "min-width: fit-content", 
            document.querySelector(".AdUnitView__adBar__timer").classList.add("fix-ad-width"), 
            console.log("trying to fix width of ad timer")), console.log("mutation occured");
            for (let mutation of mutationRecords) "characterData" === mutation.type && console.log("new: " + mutation.target + "old: " + mutation.oldValue);
        })), obsConfig2 = {
            characterData: !0,
        ...
        function checkAdStart() {
            "ad-playing" === getState() && (console.log("active ad class node added"), console.log("PEOPLE ARE WATCHING ADS"), 
            socket.emit("watchingAds", {
                watchingAds: !0
            }, (function() {})), currWatchingAds = !0, setTimeout((function() {
                console.log("trying to observe new ad Timer");
                var dynamicAdTimerWrapper = document.querySelector(".AdUnitView__adBar__timer");
                dynamicAdTimerWrapper && (console.log("observing new ad Timer"), myObserver2.observe(dynamicAdTimerWrapper, obsConfig2));
            }), 1e3));
        }
        var myObserver = new (window.MutationObserver || window.WebKitMutationObserver)((function(mutationRecords) {
            console.log("mutation occured");
            for (let mutation of mutationRecords) if ("childList" === mutation.type) {
                console.log("A child node has been added or removed.");
                for (var i = 0; i < mutation.addedNodes.length; i++) console.log("added node: " + mutation.addedNodes[i].className), 
                mutation.addedNodes[i].className.includes("AdUnitView") && checkAdStart();
                for (i = 0; i < mutation.removedNodes.length; i++) console.log("removed node: " + mutation.removedNodes[i].className), 
                mutation.removedNodes[i].className.includes("AdUnitView") && (console.log("active ad class node removed"), 
                setTimeout((function() {
                    document.querySelector(".AdUnitView") || (currWatchingAds = !1, console.log("PEOPLE STOPPED WATCHING ADS"), 
                    everyoneWatchingAds && pushTask((function() {
                        return broadcast(!0)().catch(sync);
                    })), socket.emit("watchingAds", {
                        watchingAds: !1
                    }, (function() {})));
                }), 2500));
        ...
        function startMutationObserver() {
            ...
            dynamicAdWrapper && myObserver.observe(dynamicAdWrapper, obsConfig);
        }
        var oldIcons = [ "Batman.svg", "DeadPool.svg", "CptAmerica.svg", "Wolverine.svg", "IronMan.svg", "Goofy.svg", "Alien.svg", "Mulan.svg", "Snow-White.svg", "Poohbear.svg", "Sailormoon.svg", "Sailor Cat.svg", "Pizza.svg", "Cookie.svg", "Chocobar.svg", "hotdog.svg", "Hamburger.svg", "Popcorn.svg", "IceCream.svg", "ChickenLeg.svg" ], enableIconsetFunctions = {
            ...
            saveToChrome && (chrome.storage.local.set({
                ...
                chrome.runtime.lastError ? console.log(chrome.runtime.lastError.message) : (console.log("set user nickname chrome storage data: " + JSON.stringify(data)), 
            ...
            })), userSettings.userNickname = userNickname, console.log("new user settings after set user nickname: " + JSON.stringify(userSettings)), 
            socket.emit("broadcastUserSettings", {
                userSettings
        ...
        var renderSidebar = function() {
            ...
            console.log("Icons in use: " + JSON.stringify(iconsInUse)), console.log("user Icons: " + JSON.stringify(userIcons));
        ...
        getChromeStorage()(), socket.on("updateSettings", (function(data) {
            console.log(JSON.stringify(data)), data.userSettings.userIcon && setUserIcon(data.userSettings.userId, data.userSettings.userIcon, !1), 
            data.userSettings.userNickname && setUserNickname(data.userSettings.userId, data.userSettings.userNickname, !1);
        }));
        var sessionStartTime, messages = [], unreadCount = 0, originalTitle = document.title, messagesCount = 0, summarySent = !1, chatHtml2 = "", typingTimer = null, allowFullScreen = function() {
            ...
            if (0 === jQuery("#chat-wrapper").length) {
                jQuery("#dash-player-container").after(chatHtml2), allowFullScreen(), jQuery("#presence-indicator").data("typing", !1), 
                jQuery("#presence-indicator").data("buffering", !1), setPresenceVisible(!1);
                jQuery("#user-icon").click((function(e) {
                    console.log("userIcon button clicked"), toggleIconContainer();
                }));
                ...
                window.addEventListener("message", (function(event) {
                    event.source == window && event.data.type && "FROM_COPY_WINDOW" == event.data.type && console.log("received event from window: " + event.data.text);
                }), !1);
                jQuery("#link-icon").click((function(e) {
                    console.log("linkIcon button clicked"), urlWithSessionId = "https://www.tele.pe/hulu/" + sessionId + "?s=" + serverId, 
                    console.log(urlWithSessionId), console.log("clipboard url: " + urlWithSessionId), 
                    jQuery("#share-url").val(urlWithSessionId).focus().select(), console.log("clipboard url: " + jQuery("#share-url")[0].value), 
                    document.execCommand("copy");
                }));
                jQuery(".user-icon").click((function(e) {
                    console.log("userIcon button clicked"), toggleLargeUserIconButton();
                ...
                jQuery(".image-button").click((function(e) {
                    ...
                    console.log("set input focus in nickname wrapper"), jQuery("#chat-input").blur(), 
                    jQuery("#nickname-edit").focus();
                })), jQuery("#nickname-edit").keydown((function(e) {
                    console.log("nickname keydown event"), e.stopPropagation();
                }));
                ...
                var oldPageX = null, oldPageY = null;
                jQuery("#chat-wrapper").mousedown((function(e) {
                    oldPageX = e.pageX, oldPageY = e.pageY;
                })), jQuery("#chat-wrapper").click((function(e) {
                    (e.pageX - oldPageX) * (e.pageX - oldPageX) + (e.pageY - oldPageY) * (e.pageY - oldPageY) < 5 && jQuery("#chat-input").focus(), 
                    e.stopPropagation();
                })), jQuery("#chat-input-container").click((function(e) {
                    console.log("set input focus in chat wrapper"), jQuery("#chat-input").focus();
                    ...
                    setBufferingPresenceVisible(data.anyoneBuffering), othersAreBuffering = data.anyoneBuffering;
                    var time = new Date;
                    ...
                    var time = new Date, timeStatus = " at" + time.getHours() + ":" + time.getMinutes() + ":" + time.getMilliseconds() + "AM";
                    if (console.log("received watching ads update: " + data.anyoneWatchingAds + ", " + data.everyoneWatchingAds + timeStatus), 
                    data.anyoneWatchingAds, (everyoneWatchingAds = data.everyoneWatchingAds) && (console.log("everyone watching ads UPDATE: " + state + ", " + getPlaybackPosition()), 
                    "paused" !== state)) {
                        var now = new Date, newLastKnownTime = getPlaybackPosition(), newLastKnownTimeUpdatedAt = new Date(now.getTime() - localTimeMinusServerTimeMedian);
                        oldLastKnownTime = lastKnownTime, oldLastKnownTimeUpdatedAt = lastKnownTimeUpdatedAt, 
                        oldState = state, lastKnownTime = newLastKnownTime, lastKnownTimeUpdatedAt = newLastKnownTimeUpdatedAt, 
                        state = "paused", socket.emit("updateSession", {
                            lastKnownTime: newLastKnownTime,
                            lastKnownTimeUpdatedAt: newLastKnownTimeUpdatedAt.getTime(),
                            state: "paused",
                            bufferingState: !1
                        }, (function(data) {
                            void 0 !== data && null !== data.errorMessage && (lastKnownTime = oldLastKnownTime, 
                            lastKnownTimeUpdatedAt = oldLastKnownTimeUpdatedAt, state = oldState), console.log("everyone watching ads UPDATE FINISHED");
                        }));
                    }
                }));
            } else jQuery("#chat-history").html("");
        }, getChatVisible = function() {
            return jQuery("#dash-player-container").hasClass("with-chat");
        }, setChatVisible = function(visible) {
            visible ? (jQuery("#dash-player-container").addClass("with-chat"), jQuery("#dash-player-container").css("right", "288px"), 
            jQuery("#dash-player-container").css("width", "calc(100% - 288px)"), jQuery("#chat-wrapper").show(), 
            document.hasFocus() || clearUnreadCount()) : (jQuery("#chat-wrapper").hide(), jQuery("#dash-player-container").removeClass("with-chat"), 
            jQuery("#dash-player-container").css("right", "0px"), jQuery("#dash-player-container").css("width", "100%"));
        ...
        }, setBufferingPresenceVisible = function(visible) {
            jQuery("#presence-indicator").data("buffering", visible), setPresenceText();
        }, setWatchingAdsPresenceVisible = function(visible) {
            jQuery("#presence-indicator").data("watchingAds", visible), setPresenceText(), visible && jQuery("#presence-indicator").show();
        }, setPresenceText = function() {
            var typing = jQuery("#presence-indicator").data("typing"), buffering = jQuery("#presence-indicator").data("buffering");
            jQuery("#presence-indicator").data("watchingAds") ? jQuery("#presence-indicator").text("People are watching ads...") : typing && buffering ? jQuery("#presence-indicator").text("People are typing and buffering...") : typing ? jQuery("#presence-indicator").text("People are typing...") : buffering ? jQuery("#presence-indicator").text("People are buffering...") : jQuery("#presence-indicator").text(" ");
        ...
        function logSummary() {
            try {
                if (permId && sessionStartTime && sessionId && videoId && !summarySent) {
                    ...
                    console.log("summaryData: " + JSON.stringify(data)), chrome.runtime.sendMessage({
                        summary: data
                    }, (function(response) {
        ...
        var simulClick = !1, otherEpisode = !1;
        socket.on("jumpToNextEpisode", (function(data) {
            console.log("received next Episode event: " + JSON.stringify(data)), data.otherEpisode ? continueOtherEpisode(data.nextEpisode) : continueNextEpisode(data.nextEpisode);
        }));
        var oldSessionId = null, setSessionEnabled = function(enabled) {
            console.log("SET SESSION ENABLED"), enabled ? null != oldSessionId && null == sessionId && (sessionId = oldSessionId, 
            oldSessionId = null) : null == oldSessionId && null != sessionId && (oldSessionId = sessionId, 
            sessionId = null);
        }, continueNextEpisode = function(nextEpisode) {
            var currVideoId = window.location.href.match(/^.*\/([a-z\-0-9]+)\??.*/)[1];
            console.log("continue next ep called"), currVideoId != nextEpisode && (setSessionEnabled(!1), 
            simulClick = !0, jQuery(".UpNextButton").length > 0 && (console.log("trying to click"), 
            document.querySelector(".UpNextButton").click(), console.log("trying to click done")), 
            jQuery(".end-card__metadata-area-play-button").length > 0 && (console.log("trying to click"), 
            document.querySelector(".end-card__metadata-area-play-button").click(), console.log("trying to click done")), 
            jQuery(".up-next").length > 0 && jQuery(".up-next").click(), jQuery(".WatchNext-still-hover-container").length > 0 ? jQuery(".WatchNext-still-hover-container").click() : jQuery(".button-nfplayerNextEpisode").length > 0 ? jQuery(".button-nfplayerNextEpisode").click() : jQuery(".nf-flat-button-text").length > 0 && jQuery(".nf-flat-button-text")[0].text.toLowerCase().includes("next episode") && jQuery(".nf-flat-button-text")[0].click());
        }, continueOtherEpisode = function(otherEpisode) {
            window.location.href.match(/^.*\/([a-z\-0-9]+)\??.*/)[1] != otherEpisode && (window.location.href = "https://www.hulu.com/watch/" + otherEpisode), 
        ...
        console.log("replace script loaded: " + window.replaceScriptLoaded), window.replaceScriptLoaded || (console.log("injecting replace script"), 
        ...
        var replaceStateInteraction = function(event) {
            if (event.source == window && event.data.type && "FROM_PAGE" == event.data.type) {
                console.log("***********************************"), logState = !0, console.log("Content script received: " + event.data.text);
                var episodePage = window.location.href.match(/^.*\/(watch)\/.*/);
                if (console.log(window.location.href), episodePage) {
                    var nextVideoId = window.location.href.match(/^.*\/([a-z\-0-9]+)\??.*/)[1];
                    if (nextVideoId === videoId) return void console.log("do not do anything bc replace state is called on all clicks");
                    socket.emit("nextEpisode", {
                        nextEpisode: nextVideoId,
                        simulClick,
                        otherEpisode
                    }, (function() {})), otherEpisode ? (teardown(), alert("Long parties only work for consecutive episodes for now. Please share a new Netflix Party to continue watching together.")) : otherEpisode || (console.log("replace disable session next episode"), 
                    setSessionEnabled(!1), null != oldSessionId && (console.log("oldSessionId is called"), 
                    swallow(delayUntil((function() {
                        return console.log("video unloading"), !getPlaybackPosition();
                    }), 5e3))().then(swallow(delayUntil((function() {
                        return console.log("replace state loading START"), getPlaybackPosition() && "loading" !== getState();
                    }), 1 / 0))).then(swallow(delayUntil((function() {
                        return console.log("replace state loading ADS"), "ad-playing" !== getState();
                    }), 1 / 0))).then((function() {
                        console.log("replace state loading DONE"), uiEventsHappening += 1, delay(1)().ensure((function() {
                            uiEventsHappening -= 1;
                        }));
                        var localTime = getPlaybackPosition(), now = new Date, newLastKnownTime = localTime, newLastKnownTimeUpdatedAt = new Date(now.getTime() - localTimeMinusServerTimeMedian), newState = "loading" === getState() ? "paused" : "playing" === getState() ? "playing" : "paused";
                        if (simulClick) {
                            console.log("simulClick is true NO UPDATE"), console.log("re-enabling sync after next episode"), 
                            console.log("***********************************"), console.log("loading new video handlers"), 
                            loadVideoHandlers(document.getElementsByTagName("video")[0]), logState = !1, allowFullScreen(), 
                            setSessionEnabled(!0);
                            localTime = getPlaybackPosition() || "not defined", "playing" === state && ((new Date).getTime(), 
                            lastKnownTimeUpdatedAt.getTime());
                            simulClick = !1, otherEpisode = !1, pushTask(sync);
                        } else oldLastKnownTime = lastKnownTime, oldLastKnownTimeUpdatedAt = lastKnownTimeUpdatedAt, 
                        oldState = state, lastKnownTime = newLastKnownTime, lastKnownTimeUpdatedAt = newLastKnownTimeUpdatedAt, 
                        state = newState, socket.emit("updateSession", {
                            lastKnownTime: newLastKnownTime,
                            lastKnownTimeUpdatedAt: newLastKnownTimeUpdatedAt.getTime(),
                            state: newState,
                            bufferingState: !1
                            ...
                            void 0 !== data && null !== data.errorMessage && (lastKnownTime = oldLastKnownTime, 
                            lastKnownTimeUpdatedAt = oldLastKnownTimeUpdatedAt, state = oldState), console.log("re-enabling sync after next episode"), 
                            console.log("***********************************"), console.log("loading new video handlers"), 
                            loadVideoHandlers(document.getElementsByTagName("video")[0]), logState = !1;
                            getPlaybackPosition(), "playing" === state && ((new Date).getTime(), lastKnownTimeUpdatedAt.getTime());
                            setSessionEnabled(!0);
                            getPlaybackPosition(), "playing" === state && ((new Date).getTime(), lastKnownTimeUpdatedAt.getTime());
                            simulClick = !1, otherEpisode = !1;
                        }));
                    }))));
                } else console.log("time to teardown"), teardown();
            }
        };
        ...
        })), jQuery(document).on("click", ".StandardEmphasisHorizontalTileThumbnail", (function() {
            console.log("other episode clicked!"), otherEpisode = !0;
        }));
        var sessionId = null, lastKnownTime = null, lastKnownTimeUpdatedAt = null, ownerId = null, state = null, videoId = null, videoDuration = null, currentPage = window.location.href, roundTripTimeRecent = [], roundTripTimeMedian = 0, localTimeMinusServerTimeRecent = [], localTimeMinusServerTimeMedian = 0, ping = function() {
            return new Promise((function(resolve, reject) {
                ...
                socket.emit("getServerTime", {
                    ...
                    localTimeMinusServerTimeMedian = median(localTimeMinusServerTimeRecent), resolve();
                }));
            }));
        }, sync = function() {
            return null === sessionId || "notready" === getState() || "ad-playing" === getState() ? ("ad-playing" === getState() && (console.log("AD SYNC CALLED"), 
            function(broadcast) {
                currAd = {};
                var now = new Date;
                currAd.adTimerUpdatedAt = new Date(now.getTime() - localTimeMinusServerTimeMedian), 
                currAd.userId = userSettings.userId, broadcast && broadcastCurrAd(currAd);
            }(!0)), Promise.resolve()) : "paused" === state ? ("paused" === getState() ? Promise.resolve() : pause()).then((function() {
                if (Math.abs(lastKnownTime - getPlaybackPosition()) > 3e3) return seek(lastKnownTime)();
            })) : delayUntil((function() {
                getState(), getPlaybackPosition(), "playing" === state && ((new Date).getTime(), 
                lastKnownTimeUpdatedAt.getTime());
                ...
                return Math.abs(localTime - serverTime) > 3e3 ? seek(serverTime)().then((function() {})).then((function() {
                    ...
                    return localTime > serverTime && localTime <= serverTime + 3e3 ? (milliseconds = localTime - serverTime, 
                    function() {
                        return uiEventsHappening += 1, pause(), delay(milliseconds)().then((function() {
                            play();
                        })).then(hideControls).ensure((function() {
                            uiEventsHappening -= 1;
                        }));
        ...
        }, logState = !1, oldState = getState();
        stateTimer = setInterval((function() {
            if (oldState = getState(), logState) getPlaybackPosition(), "playing" === state && ((new Date).getTime(), 
            lastKnownTimeUpdatedAt.getTime());
        }), 100);
        var broadcast = function(waitForChange) {
            return function() {
                if (null === sessionId || "notready" === getState() || "ad-playing" === getState()) return console.log("broadcast promise resolved"), 
                Promise.resolve();
                console.log("broadcast called");
                getPlaybackPosition(), "playing" === state && ((new Date).getTime(), lastKnownTimeUpdatedAt.getTime());
                var promise, oldPlaybackPosition = getPlaybackPosition(), oldState = getState(), lastState = state;
                waitForChange ? (console.log("wait for change change after broadcast"), console.log("broadcast state, playback: " + oldState + ", " + oldPlaybackPosition), 
                promise = swallow(delayUntil((function() {
                    var newPlaybackPosition = getPlaybackPosition(), newState = getState();
                    return console.log("new broadcast state, playback: " + newState + ", " + newPlaybackPosition), 
                    Math.abs(newPlaybackPosition - oldPlaybackPosition) >= 1500 || newState !== oldState || newState !== lastState;
                }), 2500))()) : (console.log("no change after broadcast"), promise = Promise.resolve());
                var alreadyUpdated = !1, bufferingState = !1;
                return promise.then(delayUntil((function() {
                    var videoDuration = 1e3 * jQuery("video")[0].duration, progress = (getPlaybackPosition(), 
                    parseFloat(jQuery(".Timeline__playedBar")[0].style.width) / 100), scrubberTime = Math.floor(videoDuration * progress);
                    console.log("scrubber Time: " + scrubberTime);
                    var now = new Date, newLastKnownTime = scrubberTime, newLastKnownTimeUpdatedAt = new Date(now.getTime() - localTimeMinusServerTimeMedian), newState = "loading" === getState() ? "paused" : "playing" === getState() ? "playing" : "paused";
                    if (!alreadyUpdated && (bufferingState = "loading" === getState())) {
                        alreadyUpdated = !0, socket.emit("buffering", {
                            buffering: !0
                        }, (function() {}));
                        var time = new Date;
                        ...
                        socket.emit("updateSession", {
                            ...
                            void 0 !== data && null !== data.errorMessage && (lastKnownTime = oldLastKnownTime, 
                            lastKnownTimeUpdatedAt = oldLastKnownTimeUpdatedAt, state = oldState);
                        }));
                    }
                    return "loading" !== getState();
                }), 1 / 0)).then((function() {
                    ...
                    var now = new Date, localTime = getPlaybackPosition(), serverTime = lastKnownTime + ("playing" === state ? now.getTime() - (lastKnownTimeUpdatedAt.getTime() + localTimeMinusServerTimeMedian) : 0), newLastKnownTime = localTime, newLastKnownTimeUpdatedAt = new Date(now.getTime() - localTimeMinusServerTimeMedian), newState = "playing" === getState() ? "playing" : "paused";
                    if (state === newState && Math.abs(localTime - serverTime) < 1) return Promise.resolve();
                    var oldLastKnownTime = lastKnownTime, oldLastKnownTimeUpdatedAt = lastKnownTimeUpdatedAt, oldState = state;
                    return lastKnownTime = newLastKnownTime, lastKnownTimeUpdatedAt = newLastKnownTimeUpdatedAt, 
                    state = newState, new Promise((function(resolve, reject) {
                        socket.emit("updateSession", {
                            lastKnownTime: newLastKnownTime,
                            lastKnownTimeUpdatedAt: newLastKnownTimeUpdatedAt.getTime(),
                            state: newState,
                            ...
                            void 0 !== data && null !== data.errorMessage ? (lastKnownTime = oldLastKnownTime, 
                            lastKnownTimeUpdatedAt = oldLastKnownTimeUpdatedAt, state = oldState, reject()) : resolve();
                        }));
                    }));
                })).then((function() {}));
            };
        }, receive = function(data) {
            return lastKnownTime = data.lastKnownTime, lastKnownTimeUpdatedAt = new Date(data.lastKnownTimeUpdatedAt), 
            state = data.state, sync;
        }, tasks = null, tasksInFlight = 0, pushTask = function(task) {
            console.log("pushTask called w tasks: " + tasksInFlight), 0 === tasksInFlight && (tasks = Promise.resolve()), 
            tasksInFlight += 1, tasks = tasks.then((function() {
            ...
            var target;
            if (console.log("mouseup"), console.log("CLICK MOUSEUP LISTENER"), console.log("CLICK MOUSEUP TIME: " + getPlaybackPosition()), 
            target = event.target, console.log(target), (jQuery(target).is("#chat-input") ? (console.log("chat input click"), 
            jQuery("#nickname-edit").blur(), 1) : jQuery(target).is("#nickname-edit") && (console.log("nickname input click"), 
            jQuery("#chat-input").blur(), 1)) || (jQuery("#chat-input").blur(), jQuery("#nickname-edit").blur()), 
            console.log("video display MOUSEUP: " + jQuery(".Player__container")[0].style.display), 
            "none" === jQuery(".Player__container")[0].style.display && teardown(), function(target) {
                return !!jQuery(target).hasClass("button-nfplayerNextEpisode") || !!jQuery(target).hasClass("WatchNext-still-hover-container") || !!jQuery(target).hasClass("button-nfplayerNextEpisode") || !!jQuery(target).hasClass("WatchNext-still-hover-container") || !!jQuery(target).hasClass("PlayIcon") || jQuery(target).hasClass("button-nfplayerNextEpisode").length > 0 || !!jQuery(target).hasClass("nf-flat-button-text") && (!!jQuery(target).text().toLowerCase().includes("next episode") || void 0);
            }(event.target)) console.log("sessionid disabled"), setSessionEnabled(!1); else {
                var sessionIdString = sessionId || "null";
                console.log("sessionId, uiEventsHappening: " + sessionIdString + ", " + uiEventsHappening), 
                null !== sessionId && 0 === uiEventsHappening ? (console.log("MOUSEUP TRY TO BROADCAST"), 
                pushTask((function() {
                    return broadcast(!0)().catch(sync);
                }))) : console.log("mouseup sessionid null");
            }
        }, keyupListener = function(e) {
            jQuery(e.target).hasClass("extension-txt") || null !== sessionId && 0 === uiEventsHappening && pushTask((function() {
                return broadcast(!0)().catch(sync);
            }));
        };
        function debounce(cb, interval, immediate) {
            ...
            return function() {
                var context = this, args = arguments, later = function() {
                    timeout = null, immediate || cb.apply(context, args);
                }, callNow = immediate && !timeout;
                clearTimeout(timeout), timeout = setTimeout(later, interval), callNow && cb.apply(context, args);
            };
        }
        jQuery(window).click(mouseupListener), window.onkeydown = debounce(keyupListener, 400);
        var onVideoSeekChange = function() {
            console.log("VIDEO SEEK CHANGE"), uiEventsHappening <= 0 && sessionId && pushTask((function() {
                return broadcast(!1)().catch(sync);
            }));
        }, loadVideoHandlers = src => {
            video = src, video.onseeking = onVideoSeekChange;
        }, scriptInterval = null, teardown = function() {
            window.postMessage({
                type: "teardown"
            }, "*"), window.removeEventListener("message", replaceStateInteraction, !1), window.removeEventListener("unload", unloadInteraction, !0), 
            jQuery(window).off("mouseup", mouseupListener), jQuery(window).off("keyup", keyupListener), 
            sessionId && (sessionId = null), window.netflixPartyLoaded = !1, chrome.runtime.onMessage.removeListener(popupInteraction), 
            socket && socket.disconnect(), scriptInterval && clearInterval(scriptInterval), 
            setChatVisible(!1), clearUnreadCount(), jQuery("#chat-container").remove(), jQuery("#chat-wrapper").remove(), 
            jQuery("#dash-player-container").removeClass("with-chat"), jQuery("#dash-player-container").css("right", "0px"), 
            window.netflixpartyLoaded = !1, logState = !1;
        };
        socket.on("connect", (function() {
            pushTask(ping), console.log(currentPage);
            new Date;
            scriptInterval = setInterval((function() {
                if (0 === tasksInFlight) {
                    new Date;
                    new Date, pushTask(ping), pushTask(sync);
                }
            }), 5e3);
        })), socket.on("reconnect", (function() {
            null !== sessionId && socket.emit("reboot", {
                sessionId,
                lastKnownTime,
        ...
        var popupInteraction = function(request, sender, sendResponse) {
            return console.log("THIS CALLED"), console.log("referrer 2: " + window.document.referrer), 
            "getInitData" === request.type ? (version = request.data.version, void sendResponse({
                sessionId,
                referrer: window.document.referrer,
                serverId,
                chatVisible: getChatVisible()
            })) : "createSession" === request.type ? (waitVideoReady()().then((function() {
                console.log("CREATE SESSION: " + sessionId), socket.emit("createSession", {
                    ...
                    console.log("create session data: " + JSON.stringify(data)), initChat(), setChatVisible(!0), 
                    loadVideoHandlers(document.getElementsByTagName("video")[0]), startMutationObserver(), 
                    checkAdStart(), lastKnownTime = data.lastKnownTime, lastKnownTimeUpdatedAt = new Date(data.lastKnownTimeUpdatedAt), 
                    messages = [], sessionId = data.sessionId, ownerId = request.data.controlLock ? userId : null, 
                    state = data.state, videoId = request.data.videoId, videoDuration = getDuration(), 
                    pushTask(broadcast(!1)), sessionStartTime = new Date, sendResponse({
                        sessionId
                    });
                }));
            })), !0) : "joinSession" === request.type ? (waitVideoReady()().then((function() {
                var joinData = herokuSocket ? request.data.sessionId : {
                ...
                console.log("joinData: " + JSON.stringify(joinData)), socket.emit("joinSession", joinData, (function(data) {
                    if (data.errorMessage) sendResponse({
                        errorMessage: data.errorMessage
                    }); else if (data.videoId === request.data.videoId) {
                        initChat(), setChatVisible(!0), loadVideoHandlers(document.getElementsByTagName("video")[0]), 
                        startMutationObserver(), checkAdStart(), sessionId = request.data.sessionId, lastKnownTime = data.lastKnownTime, 
                        lastKnownTimeUpdatedAt = new Date(data.lastKnownTimeUpdatedAt), messages = [];
                        for (var i = 0; i < data.messages.length; i += 1) addMessage(data.messages[i], !0);
                        ownerId = data.ownerId, state = data.state, videoId = request.data.videoId, videoDuration = getDuration(), 
                        console.log("received join data: " + JSON.stringify(data)), pushTask(receive(data)), 
                        sendResponse({});
                    } else socket.emit("leaveSession", null, (function(data) {
                        sendResponse({
                ...
                logSummary(), sessionId = null, setChatVisible(!1), sendResponse({});

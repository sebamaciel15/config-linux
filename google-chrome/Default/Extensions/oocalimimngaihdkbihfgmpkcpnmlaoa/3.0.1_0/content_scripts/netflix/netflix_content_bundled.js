(() => {
    ...
    (() => {
        ...
        const Netflix = new class extends class {
        ...
        const Services_Netflix = Netflix, VideoLoadError = "Failed to load video in time. Please refresh the page and try again.";
        ...
        class NetflixVideoApi extends class {
            ...
            _getVideoId() {
                ...
                return null != videoDomId && videoDomId != currVideoId && (debug("Replacing with dom id"), 
        ...
        window.telepartyLoaded || (window.telepartyLoaded = !0, new NetflixContentScript, 

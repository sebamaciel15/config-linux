(() => {
    ...
    (() => {
        ...
        function DisneyChatApi_defineProperty(obj, key, value) {
            return key in obj ? Object.defineProperty(obj, key, {
                value,
                enumerable: !0,
                configurable: !0,
        ...
        class DisneyChatApi extends class {
            ...
            constructor() {
                super(), DisneyChatApi_defineProperty(this, "_shouldChatBeVisible", void 0), this._shouldChatBeVisible = !1;
            }
            _injectChat() {
            ...
            setChatVisible(visible) {
                this._shouldChatBeVisible = visible, visible ? (jQuery(DisneyChatApi.MAIN_WRAPPER_SELECTOR).addClass("with-chat"), 
        ...
        DisneyChatApi_defineProperty(DisneyChatApi, "MAIN_WRAPPER_SELECTOR", "#hudson-wrapper");
        ...
        let PlaybackState, SessionState, StreamingServiceName;
        ...
        const DisneyPlus = new class extends class {
        ...
        class DisneyVideoApi extends class {
            ...
            constructor() {
                var obj, key, value;
                super(), value = void 0, (key = "_video") in (obj = this) ? Object.defineProperty(obj, key, {
                    value,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
                }) : obj[key] = value, this._uiEventsHappening = 0, console.log("Diseny video");
            }
        ...
        class DisneyVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi) {
                ...
                DisneyVideoEventListener_defineProperty(this, "_videoApi", void 0), DisneyVideoEventListener_defineProperty(this, "_wrapperObserver", void 0), 
                DisneyVideoEventListener_defineProperty(this, "_loadingObserver", void 0), DisneyVideoEventListener_defineProperty(this, "_onUpdate", this._onVideoUpdate.bind(this)), 
                DisneyVideoEventListener_defineProperty(this, "_onReplace", this.replaceStateInteraction.bind(this)), 
                this._videoApi = videoApi, this._chatApi = chatApi, this._wrapperObserver = new MutationObserver((mutationsList => {
            ...
            async loadNewVideoAsync(videoId) {
                ...
                await new Promise(((resolve, reject) => {
                    const interval = setInterval((() => {
                        ...
                        performance.now() - start >= 25e3 && (clearInterval(interval), reject(new Error("Could not load new video in time.")));
                    }), 100);
        ...
        class DisneyContentScript extends class {
            ...
            constructor() {
                ...
                super(disneyChatApi, disneyVideoApi, new DisneyVideoEventListener(disneyVideoApi, disneyChatApi)), 
                debug("Disney Content Script");
            }
        }
        window.telepartyLoaded || (window.telepartyLoaded = !0, new DisneyContentScript, 
